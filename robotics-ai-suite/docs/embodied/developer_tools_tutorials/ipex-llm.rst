...
| Before installing Intel® LLM Library for PyTorch, ensure to complete the environment setup in :doc:`../installation_setup` and have Intel® oneAPI™ Base Toolkit installed.
